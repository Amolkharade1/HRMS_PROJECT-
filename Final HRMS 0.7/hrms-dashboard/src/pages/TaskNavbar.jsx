  ...
  return (
    <>
      ...
      <div className="all-tabs">
        <Link to="/MyTasks" className={`all-tab ${location.pathname === '/MyTasks' ? 'active' : ''}`}>My Task</Link>
        <Link to="/TrackTasks" className={`all-tab ${location.pathname === '/TrackTasks' ? 'active' : ''}`}>Track Task</Link>
        <Link to="/AllTasks" className={`all-tab ${location.pathname === '/AllTasks' ? 'active' : ''}`}>All Task</Link>
        <Link to="/FormView" className={`all-tab ${location.pathname === '/FormView' ? 'active' : ''}`}>From View</Link>
      </div>
    </>
  );
};
