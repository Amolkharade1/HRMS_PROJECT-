    ...
    return (
        <>
            ...
            <div className="all-tabs">
                <Link to="/leavesummary" className={`all-tab ${location.pathname === '/leavesummary' ? 'active' : ''}`}>
                   Leave Summary
                </Link>
                <Link to="/leavebalance" className={`all-tab ${location.pathname === '/leavebalance' ? 'active' : ''}`}>Leave Balance
                </Link>
                <Link to="/leaverequests" className={`all-tab ${location.pathname === '/leaverequests' ? 'active' : ''}`}>Leave Requests
                </Link>
                <Link to="/shiftschedule" className={`all-tab ${location.pathname === '/shiftschedule' ? 'active' : ''}`}>
                   Shift
                </Link>
            </div>
        </>
