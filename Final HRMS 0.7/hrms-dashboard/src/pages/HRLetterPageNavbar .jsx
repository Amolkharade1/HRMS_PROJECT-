    ...
    return (
        <>
            ...
            <div className="all-tabs">
                ...
                <Link to="/BonafideLetter" className={`all-tab ${location.pathname === '/BonafideLetter' ? 'active' : ''}`}>Bonafide Letter
                </Link>
                <Link to="/ExperienceLetter" className={`all-tab ${location.pathname === '/ExperienceLetter' ? 'active' : ''}`}>Experience Letter
                </Link>
                {/* <Link to="/file-folder" className={`all-tab ${location.pathname === '/file-folder' ? 'active' : ''}`}>Folder
                </Link> */}
            </div>
        </>
    );
