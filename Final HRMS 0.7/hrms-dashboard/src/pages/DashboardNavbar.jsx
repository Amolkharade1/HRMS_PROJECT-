  ...
  return (
    <>
        ...
        <div className="all-nav-icons">
          ...
          {showQuickActions && (
            <div className="all-quick-actions-dropdown" ref={quickActionsRef}>
              ...
              <input type="text" placeholder="Search" className="all-dropdown-search" onClick={() => setShowSearchInput(!showSearchInput)}/>
      ...
      <div className="all-tabs">
        <Link to="/homepage" className={`all-tab ${location.pathname === '/homepage' ? 'active' : ''}`}>Overview</Link>
        <Link to="/dashboard" className={`all-tab ${location.pathname === '/dashboard' ? 'active' : ''}`}>Dashboard</Link>
      </div>
    </>
  );
};
